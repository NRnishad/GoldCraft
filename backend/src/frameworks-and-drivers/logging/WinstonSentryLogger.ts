...
export class WinstonSentryLogger implements ILogger {
  ...
  constructor() {
    ...
    const logFormat = winston.format.combine(
      ...
      // FIX: Use winston.format.colorize directly instead of the non-existent .init()
...
// Single instance export for dependency routing throughout initialization wrappers
export const appLogger: ILogger = new WinstonSentryLogger();